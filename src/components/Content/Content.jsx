...
function Content() {
  return (
    <main className="bg-[linear-gradient(150deg,#ff6a12_20%,#e8292b_100%)] sm:h-auto lg:h-full sm:w-screen flex justify-center items-center">
      <div className="sm:w-full flex flex-col justify-center items-center gap-y-6">
        ...
        <div className="flex justify-center items-center mb-17 gap-x-5">
          <ButtonIcon
          icon={faceIcon}
